...
public class Chapter1Fragment2 extends Fragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_chapter1_fragment2, container, false);

        final Chapter1Fragment1 chapter1Fragment1 = new Chapter1Fragment1();
        ...
        leftButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                transaction.replace(R.id.fragment_container, chapter1Fragment1);
